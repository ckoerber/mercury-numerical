...
We also provide a working example program that can be used as a template \url{this-upload-url}\todo{url once uploaded (arXiv)}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{@CK: installation python+vpython win+linux}
\subsection{Mac}
...
%------------------------------------------
\todo[inline]{@CK: running python win+linux}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{@CK: inline code + script + test code + confirm data}
