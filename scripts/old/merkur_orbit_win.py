...
# Da es unglaublich viel Zeit kostet ein Programm fÃ¼r 3-dimensionale graphische Darstellung selber 
# zu schreiben, lassen wir uns die Arbeit von "Vpython" abnehmen. Doch dazu mÃ¼ssen wir zunÃ¤chst 
...
# WÃ¼rde man 
#   "import visual" 
# schreiben, so mÃ¼sste man die Funktion wie folgt aufrufen: 
#   "func = visual.function(..)".

# Eine Dokumentation von Modulen lÃ¤sst sich durch den Befehl "help( modul_name )" aufrufen.
#
# Tipp: Will man eine Eingabe unterdrÃ¼cken, so lÃ¤sst sich dies auch mit "#" tun. Der darauf 
# folgende Text wird dabei von Python Ã¼berlesen.
